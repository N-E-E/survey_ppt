import{d as _,$ as d,y as h,b as a,e as t,x as s,A as r,F as f,Z as v,o as n,a0 as g,l as x,g as b}from"../modules/vue-CTgvBLQu.js";import{u as y,h as N,c as m,b as k}from"../index-DIXh-Ak6.js";import{N as w}from"./NoteDisplay-ZivaHNKA.js";import"../modules/shiki-BHubiYO5.js";const D={id:"page-root"},L={class:"m-4"},T={class:"mb-10"},V={class:"text-4xl font-bold mt-2"},B={class:"opacity-50"},C={class:"text-lg"},H={class:"font-bold flex gap-2"},S={class:"opacity-50"},A=t("div",{class:"flex-auto"},null,-1),E={key:0,class:"border-main mb-8"},F=_({__name:"print",setup(M){const{slides:u,total:p}=y();d(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
